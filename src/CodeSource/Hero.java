...
public class Hero {
	...
	public Hero(String name) {
		...
		data = data.substring(data.indexOf("> Role"), data.lastIndexOf("<th> Energy Regen") + 50);

		String role = data.substring(data.indexOf("<td>") + 5, data.indexOf("</td>") - 1);
		...
		Double health = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Health Regen") + 29);
		Double healthRegen = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));
		...
		Double speed = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Attack Speed") + 29);
		Double attackSpeed = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Attack Range") + 29);
		Double attackRange = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Attack Damage") + 30);
		Double attackDamage = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Max Health") + 27);
		Double healthPerLevel = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Health Regen") + 29);
		Double healthRegenPerLevel = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Splash Damage") + 30);
		Double attackDamagePerLevel = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Max Energy") + 27);
		Double energyPerLevel = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));

		data = data.substring(data.indexOf("<th> Energy Regen") + 29);
		Double energyRegenPerLevel = Double.valueOf(data.substring(0, data.indexOf("</td>") - 1));
